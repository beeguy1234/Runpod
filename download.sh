...
ARIA2_OPTS="-c -x 2 -s 2 --log-level=warn"
...
ALL_DOWNLOADS[SD3_5_VAE]="https://huggingface.co/stabilityai/stable-diffusion-3.5-large/resolve/main/vae/diffusion_pytorch_model.safetensors|vae|SD3_5.safetensors"
...
ALL_DOWNLOADS[FLUX_boring_elements]="https://civitai.com/api/download/models/922772?type=Model&format=SafeTensor|loras|boring-elements.safetensors"
...
# reminder : er is ook een vitpose H (huge) ipv L (large), te testen ? zie  https://github.com/kijai/ComfyUI-WanAnimatePreprocess?tab=readme-ov-file
...
ALL_DOWNLOADS[QWEN-Image-Edit-2509-Next-Scene-lora]="https://huggingface.co/lovis93/next-scene-qwen-image-lora-2509/resolve/main/next-scene_lora-v2-3000.safetensors|loras"
...
GROUP_QWEN_IMAGE_EDIT=(
    ...
    "QWEN-Image-Edit-2509-Next-Scene-lora"
    "Qwen_rotate_lora"
